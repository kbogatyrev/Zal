...
//        StLexemeProperties& stGetPropertiesForWriteAccess();
        ...
        void SetGetAspectPair(String^% sAspectPair, int% iStressPos);
        EM_ReturnCode eGetAltAspectPair(String^% sAltAspectPair, int% iAltStressPos);
        void SetGetAltAspectPair(String^% sAltAspectPair, int% iAltStressPos);
        ...
        void PastParticipleRestricted(bool);
        bool bNoLongForms();
        void NoLongForms(bool);
